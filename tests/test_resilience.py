...
class TestEncodingResilience:
    ...
    def test_text_sanitization(self):
        ...
        problematic_text = "Text with \x00\x01\x02 problematic chars\r\nand line endings"
...
class TestCLIResilience:
    ...
    def test_continue_on_error_flag(self):
        ...
        results = [
            ...
            ProcessingResult(Path("file2.md"), False, error="Parse failed", error_type="parsing_error"),
        ]
        missing_files = []
    ...
    def test_processing_result_class(self):
        ...
        # Test failed result
        failed_result = ProcessingResult(Path("test.md"), False, error="Parse failed", error_type="parsing_error")
